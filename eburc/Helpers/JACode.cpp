...
void JACode::ConvertLatin( const char *input_word, char *word, EBWordCode *word_code )
{
...
void JACode::ConvertEUCJP( const char *input_word, char *word, EBWordCode *word_code )
{
	char *wp = ( char * ) word;
...
void JACode::ConvertKataJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::ConvertHiraJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::ConvertLowerLatin( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
...
void JACode::ConvertLowerJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::ConvertLongVowelsJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::DeleteLongVowelsJIS( char *word )
{
	unsigned char *in_wp = ( unsigned char * ) word;
	unsigned char *out_wp = ( unsigned char * ) word;
	unsigned char c1, c2;
 ...
 */
void JACode::ConvertDoubleConsonantsJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
 ...
 */
void JACode::ConvertContractedSoundsJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::ConvertSmallVowelsJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::ConvertVoicedConsonantsJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::ConvertPSoundsJIS( char *word )
{
	unsigned char *wp = ( unsigned char * ) word;
	unsigned char c1, c2;
...
void JACode::DeleteSpacesLatin( char *word )
{
	unsigned char *in_wp = ( unsigned char * ) word;
	unsigned char *out_wp = ( unsigned char * ) word;
...
void JACode::DeleteSpacesJIS( char *word )
{
	unsigned char *in_wp = ( unsigned char * ) word;
	unsigned char *out_wp = ( unsigned char * ) word;
	unsigned char c1, c2;
